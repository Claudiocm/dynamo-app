package br.com.ccm.dynamoapp.controller;

import br.com.ccm.dynamoapp.entity.PlayerHistoryEntity;
...
public class PlayerController {
    ...
    public ResponseEntity<List<PlayerHistoryEntity>> find(@PathVariable("username") String username) {
    ...
    public ResponseEntity<Void> updatePlayer(@PathVariable("username") String username,
                                             @PathVariable("gameId") String gameId,
    ...
    public ResponseEntity<Void> deletePlayer(@PathVariable("username") String username,
                                             @PathVariable("gameId") String gameId) {
        var entity = dynamoDbTemplate.load(Key.builder()
                .partitionValue(username)
                .sortValue(gameId)
